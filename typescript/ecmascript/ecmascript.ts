...
if(estaFrio) {
    var acao: string = 'Colocar o casaco!'
    console.log(acao)
}
...
var segredo: string = 'externo!'
function revelar() {    
    var segredo: string = 'interno'
    console.log(segredo)
}
revelar()
console.log(segredo)
...
// Exercicio 5
const [notas1, notas2, notas3]: Array<number> = [8.5, 6.3, 9.4]
...
const { primeiroNome, experiencia }: Cientista = cientista
